...
```Shell
$ http http://localhost:8000/airlines/ "Authorization: Token daa1c80567404b25f3f36f1a37fd670d6dceeb29"
```
...
There are three main resources in the API, [Airlines](#airlines), [Airports](#airports), and [Routes](#routes).
### Root 
